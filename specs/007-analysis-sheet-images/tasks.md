...
- [ ] T001 Create `normalise_analysis_sheets.py` at repo root following the
...
- [ ] T002 [P] Add a renderer stub script `tests/fixtures/fake_renderer.py` that
...
- [ ] T003 In `normalise_analysis_sheets.py`, implement
  ...
  research R7).
- [ ] T004 In `normalise_analysis_sheets.py`, implement
...
- [ ] T005 [P] [US1] In `tests/test_normalise_analysis_sheets.py` add
...
- [ ] T006 [P] [US2] In `tests/test_normalise_analysis_sheets.py` add
  `test_docx_only_folder_produces_png`: as T005 but `bbb_analysis.docx`.
- [ ] T007 [P] [US1] In `tests/test_normalise_analysis_sheets.py` add
...
- [ ] T008 [P] [US2] In `tests/test_normalise_analysis_sheets.py` add
...
- [ ] T009 [P] [US1] In `tests/test_extract_to_csv.py` add
...
- [ ] T010 [US1] In `normalise_analysis_sheets.py`, implement
...
- [ ] T011 [US1] In `normalise_analysis_sheets.py`, implement the `main()` scan
...
- [ ] T012 [US2] In `extract_to_csv.py` `gram_to_rows` analysis-row block
...
- [ ] T013 [P] [US2] In `mock_pptx.py`, extend the analysis-sheet mix at L540 from
...
- [ ] T014 [US1] Update `run_pipeline.bat`: insert
...
- [ ] T015 [P] [US3] In `tests/test_normalise_analysis_sheets.py` add
...
- [ ] T016 [P] [US3] In `tests/test_normalise_analysis_sheets.py` add
...
- [ ] T017 [P] [US3] In `tests/test_extract_to_csv.py` add
...
- [ ] T018 [US3] In `normalise_analysis_sheets.py`, make `render_doc_to_png`
  ...
  raises. (FR-008)
- [ ] T019 [US3] In `normalise_analysis_sheets.py`, implement
...
- [ ] T020 [US3] In `normalise_analysis_sheets.py`, implement the end-of-run
...
- [ ] T021 [US3] In `extract_to_csv.py` analysis-row block, when the redirected
...
- [ ] T022 [P] In `tests/test_normalise_analysis_sheets.py` add
...
- [ ] T023 [P] In `tests/test_normalise_analysis_sheets.py` add
...
- [ ] T024 In `normalise_analysis_sheets.py`, implement `tidy_image(png: Path) ->
...
- [ ] T025 In `normalise_analysis_sheets.py`, call `tidy_image` in `main` right
...
- [ ] T026 [P] In `tests/test_normalise_analysis_sheets.py` add
  ...
  `docx_wrapped=True`.
- [ ] T027 [P] In `tests/test_normalise_analysis_sheets.py` add
...
- [ ] T028 In `normalise_analysis_sheets.py`, implement `wrap_png_in_docx(png:
...
- [ ] T029 In `normalise_analysis_sheets.py` `main`, for an analysis sheet that
...
- [ ] T030 [P] Update `tests/test_run_pipeline_bat.py`
...
- [ ] T031 [P] Update `tests/test_mock_pptx.py`
  ...
  once `doc` is added).
- [ ] T032 [P] In `README.md`, add a "Renderer prerequisites" section:
...
- [ ] T033 [P] In `specs/001-pptx-dita-migration/contracts/csv-schema.md`, clarify
...
- [ ] T034 [P] In `specs/001-pptx-dita-migration/contracts/cli-contracts.md`, add a
  `normalise_analysis_sheets.py` stanza mirroring
  `specs/007-analysis-sheet-images/contracts/normalise-cli.md`.
- [ ] T035 Run `python -m unittest discover tests/` and confirm the whole suite is
  ...
  installed.
- [ ] T036 Execute `specs/007-analysis-sheet-images/quickstart.md` end-to-end
